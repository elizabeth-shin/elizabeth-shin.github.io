...
AI-powered tools built and deployed using the Claude API:

- **[Japan Travel Itinerary Generator](https://cozy-raindrop-b192e2.netlify.app/)** — Generates personalized Japan travel itineraries based on destination, budget, travel month, and trip length. Built with HTML, JavaScript, and the Claude API. Deployed on Netlify.
